...
class upload_win:
    def __init__(self, frame, func_dict, logged, top=None):
        ...
        self.Frame1.configure(relief="groove")
        self.Frame1.configure(background="#627edf")
        ...
        self.name_lbl.configure(background="#8bdc65")
        ...
        self.num_rooms_lbl.configure(background="#8bdc65")
        ...
        self.num_rooms_lbl.configure(highlightbackground="#d9d9d9")
        ...
        self.lbl_people.configure(background="#8bdc65")
        ...
        self.lbl_people.configure(highlightbackground="#d9d9d9")
        ...
        self.price_lbl.configure(background="#8bdc65")
        ...
        self.lbl_owner.configure(background="#8bdc65")
        ...
        self.lbl_owner.configure(highlightbackground="#d9d9d9")
        ...
        self.map_lunch.configure(background="#d9d9d9")
        ...
        self.Frame2.configure(relief="groove")
        self.Frame2.configure(background="#8952ef")
        ...
        self.Frame2_1.configure(relief="groove")
        self.Frame2_1.configure(background="#8952ef")
        ...
        self.top_lbl.configure(background="#d9d9d9")
        ...
        self.lbl_description.configure(background="#8bdc65")
        ...
        self.lbl_description.configure(highlightbackground="#d9d9d9")
        ...
        self.lbl_rules.configure(background="#8bdc65")
        ...
        self.lbl_rules.configure(highlightbackground="#d9d9d9")
        ...
        self.entry_description.configure(font="TkTextFont")
        self.entry_description.configure(foreground="black")
        self.entry_description.configure(highlightbackground="#d9d9d9")
        ...
        self.entry_rules.configure(font="TkTextFont")
        self.entry_rules.configure(foreground="black")
        self.entry_rules.configure(highlightbackground="#d9d9d9")
        ...
        self.Frame2_2.configure(relief="groove")
        self.Frame2_2.configure(background="#8952ef")
        ...
        self.Frame2_1_1.configure(relief="groove")
        self.Frame2_1_1.configure(background="#8952ef")
        self.Frame2_1_1.configure(highlightbackground="#d9d9d9")
        ...
        self.lbl_images.configure(background="#8bdc65")
        ...
        self.lbl_images.configure(highlightbackground="#d9d9d9")
        self.lbl_images.configure(highlightcolor="black")
        self.lbl_images.configure(text='''Image path:''')

        self.Frame3 = tk.Frame(self.Frame1)
        self.Frame3.place(relx=0.698, rely=0.671, relheight=0.205, relwidth=0.22)
        ...
        self.Canvas1 = tk.Canvas(self.Frame3)
        ...
        self.entry_num_rooms.configure(font="TkFixedFont")
        self.entry_num_rooms.configure(foreground="#000000")
        self.entry_num_rooms.configure(highlightbackground="#d9d9d9")
        ...
        self.entry_num_beds.configure(font="TkFixedFont")
        self.entry_num_beds.configure(foreground="#000000")
        self.entry_num_beds.configure(highlightbackground="#d9d9d9")
        ...
        self.entry_owner.configure(font="TkFixedFont")
        self.entry_owner.configure(foreground="#000000")
        self.entry_owner.configure(highlightbackground="#d9d9d9")
        ...
        self.entry_images.configure(font="TkFixedFont")
        self.entry_images.configure(foreground="#000000")
        self.entry_images.configure(highlightbackground="#d9d9d9")
