...
class win_admin:
    def __init__(self, frame, func_dict, logged_user, top=None):
        ...
        self.home_btn.configure(command=lambda: (self.top.geometry("%dx%d+523+254" % (defx, defy)), self.top.resizable(1,  1) ,self.Frame1.destroy()))
