...
#    Apr 30, 2022 04:56:00 PM +0300  platform: Windows NT
import _thread
...
class renting_page:
    def __init__(self,s_apartment, search_details, days, func_dict, logged, client_socket, top=None):
        ...
        self.summary_lstbox.configure(font="TkFixedFont")
        ...
        self.timer_lbl.configure(text='''You have one minute to make your choice''')
        ...
        self.Label2.configure(text='''Thank you for choosing TempHouse Services''')
        ...
        self.order_but.configure(command=lambda : func_dict.get("book_room")(s_apartment,
                                                                             order_support.make_reservation(self.full_name.get(), self.email.get(),
